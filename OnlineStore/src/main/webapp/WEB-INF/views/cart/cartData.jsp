    ...
    <c:if test="${!empty cartExtendedDTO.curCart}">
        <c:forEach items="${cartExtendedDTO.curCart.cartItem}" var="c">
            <tr class="productItem">
                ...
                <td>
                    <i class="fas fa-minus cartDecItem" style="margin-right: 1vw; display: inline-block;"> </i>
                    <p class="amount" style="display: inline-block">${c.amount}</p>
                    <i class="fas fa-plus cartIncItem" style="margin-left: 1vw; display: inline-block;"></i>
                </td>
